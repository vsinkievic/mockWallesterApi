...
describe('Card Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'a0e18168-f45c-48e4-b16a-0a0b8da485bd' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '48ab7313-5b00-44ce-be99-b026f6d0ba0c' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.cards()[0]).toEqual(expect.objectContaining({ id: 'a0e18168-f45c-48e4-b16a-0a0b8da485bd' }));
  });

  describe('trackId', () => {
    it('should forward to cardService', () => {
      const entity = { id: 'a0e18168-f45c-48e4-b16a-0a0b8da485bd' };
