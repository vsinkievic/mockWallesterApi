...
describe('Company Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: 'e3c7007e-9185-4b2d-90f0-9e5ec8b5921f' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '923bfdd4-0968-49ec-af05-6987429bf810' }],
            headers: new HttpHeaders({
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.companies()[0]).toEqual(expect.objectContaining({ id: 'e3c7007e-9185-4b2d-90f0-9e5ec8b5921f' }));
  });

  describe('trackId', () => {
    it('should forward to companyService', () => {
      const entity = { id: 'e3c7007e-9185-4b2d-90f0-9e5ec8b5921f' };
